...
describe PagesController do
  ...
  describe "GET 'admin'" do
    ...
    describe "for logged-in admins" do
      ...
      it "should have a see ownerships link" do
        get :admin
        response.should have_selector("a", :href => pages_ownerships_path, :content => "See user ownerships")
      end
  ...
  describe "GET 'ownerships'" do
    ...
    describe "for logged-in admins" do
      ...
      it "should have the right title" do
        get :ownerships
        response.should have_selector("title", :content => "User Ownerships")
      end
